...
class uniteController extends Controller
{
  public function view(){
    ...
    return view('employee.unite.view_unite',compact('all_unite'));
  }


  public function add(){
    return view('employee.unite.add_unite');
  }
  ...
  public function edite($id){
    $edite=unite::find($id);
      return view('employee.unite.edite',compact('edite'));
  }
  ...
  public function update(Request $request,$id){
    ...
    $unite_update->save();
    return redirect()->route('employee.unite.view');
  }
