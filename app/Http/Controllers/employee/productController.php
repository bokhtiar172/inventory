...
class productController extends Controller
{
          ...
          public function view(){
            ...
            return view('employee.product.view_product',compact('all_product'));
          }
          ...
          public function add(){
            ...
            return view('employee.product.add_product',compact('category','unite','supplier'));
          }
          ...
          public function edite($id){
            ...
            $unite=unite::latest()->get();
            $supplier=supplier::latest()->get();
              return view('employee.product.edite',compact('edite','category','unite','supplier'));
          }
              ...
              $image=$request->file('product_image');
                   if ($image){
                     ...
                     $success=$image->move($upload_path,$image_full_name);
                         ...
                         $product_update->save();
                         return redirect()->route('employee.product.view');
                                       }
                                  }
                            }
