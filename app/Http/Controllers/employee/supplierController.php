...
class supplierController extends Controller
{
  public function view(){
    ...
    return view('employee.supplier.view_supplier',compact('all_supplier'));
  }


  public function add(){
    return view('employee.supplier.add_supplier');
  }
  ...
  public function edite($id){
    $edite=supplier::find($id);
      return view('employee.supplier.edite',compact('edite'));
  }
  ...
  public function update(Request $request,$id){
    ...
    return redirect()->route('employee.supplier.view')->with($notification);
  }
