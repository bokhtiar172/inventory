...
class customerController extends Controller
{
    public function view(){
      ...
      return view('manager.customer.view_customer',compact('all_customer'));
    }


    public function add(){
      return view('manager.customer.add_customer');
    }
    ...
    public function edite($id){
      $edite=customer::find($id);
        return view('manager.customer.edite',compact('edite'));
    }
    ...
    public function update(Request $request,$id){
      ...
      return redirect()->route('manager.customer.view');
    }
