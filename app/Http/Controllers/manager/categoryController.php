...
class categoryController extends Controller
{
      ...
      public function view(){
        ...
        return view('manager.category.view_category',compact('all_category'));
      }
      ...
      public function edite($id){
        $edite=category::find($id);
          return view('manager.category.edite',compact('edite'));
      }
      ...
      public function update(Request $request,$id){
        ...
        return redirect()->route('manager.category.view');
      }
