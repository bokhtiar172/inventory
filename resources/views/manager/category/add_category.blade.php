...
<a style="background-color: #138D75; " class="btn text-light" href="{{route('manager.category.view')}}"><span class="mr-1"><i class="fas fa-th-list"></i></span> <strong> View All Category</strong> </a>


       <h3 class="text-center text-light bg-info mt-1">Add Category</h3>
       <form class="" action="{{route('manager.category.store')}}" method="post">
        @csrf
       <div class="row">
