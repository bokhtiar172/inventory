...
@section('manager_content')
    ...
    <section>
      <div class="row justify-content-center"><!--start of releted info of product -->
        <div class="col-md-10">
          <a style="background-color: #138D75; " class=" btn text-light mt-4" href="{{route('manager.product.view')}}"><span class="mr-1"><i class="fas fa-th-list"></i></span> <strong> View All Product</strong> </a>

          <form class="" action="{{route('manager.product.store')}}" enctype="multipart/form-data" method="post">
            @csrf
