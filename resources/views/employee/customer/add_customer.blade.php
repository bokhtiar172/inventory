...
<a style="background-color: #138D75; " class="btn text-light" href="{{route('employee.customer.view')}}"><span class="mr-1"><i class="fas fa-th-list"></i></span> <strong> View All Customer</strong> </a>


       <h3 class="text-center text-light bg-info mt-1">Add Customer</h3>
       <form class="" action="{{route('employee.customer.store')}}" method="post">
        @csrf
       <div class="row">
