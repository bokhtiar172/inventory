...
<a style="background-color: #138D75; " class="btn text-light" href="{{route('employee.customer.view')}}"><span class="mr-1"><i class="fas fa-th-list"></i></span> <strong> View All Supplier</strong> </a>


       <h3 class="text-center text-light bg-info mt-1">Edite Customer Info</h3>
       <form class="" action="{{url('employee/customer/update/'.$edite->id)}}" method="post">
        @csrf
       <div class="row">
